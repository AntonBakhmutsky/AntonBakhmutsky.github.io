...
header
  h1 Expense Tracker
section
  div Available Funds: {{ data.availableFunds }}
  div Total Expenses: {{ data.currentExpenses }}
  hr
  div Funds left: {{ remainingFunds }}
section
  form(@submit.prevent='addExpense')
    div
      label(for='amount') Amount
      input#amount(type='number' v-model='data.enteredExpense')
    button Add Expense
</template>
