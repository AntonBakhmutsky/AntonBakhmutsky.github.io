	...
	<div id="basket_items_list">
		<div class="bx_ordercart_order_table_container">
			<table id="basket_items">
				...
				<tbody>
                <?
                $skipHeaders = ['PROPS', 'DELAY', 'DELETE', 'TYPE'];
															...
															<div class="bx_scu">
																...
																>
                                                                    ...
                                                                    foreach ($arProp["VALUES"] as $valueId => $arSkuValue):
																		...
																		>
																			<a href="javascript:void(0)" class="cnt"><span class="cnt_item"
		...
		<div class="bx_ordercart_order_pay">
			...
			<div class="bx_ordercart_order_pay_left" id="coupons_block">
                ...
                if ($arParams["HIDE_COUPON"] != "Y") {
					...
					<span><?= GetMessage("STB_COUPON_PROMT") ?></span><input type="text" id="coupon" name="COUPON" value="" onchange="enterCoupon();">&nbsp;<a
                    ...
                    if (! empty($arResult['COUPON_LIST'])) {
                        foreach ($arResult['COUPON_LIST'] as $oneCoupon) {
							...
							<div class="bx_ordercart_coupon"><input disabled readonly type="text" name="OLD_COUPON[]"
							                                        value="<?= htmlspecialcharsbx($oneCoupon['COUPON']); ?>" class="<?
                            echo $couponClass; ?>"><span class="<?
                            echo $couponClass; ?>" data-coupon="<?
                            echo htmlspecialcharsbx($oneCoupon['COUPON']); ?>"></span>
							<div class="bx_ordercart_coupon_notes"><?
                                if (isset($oneCoupon['CHECK_CODE_TEXT'])) {
                                    echo(is_array($oneCoupon['CHECK_CODE_TEXT']) ? implode(
                                        '<br>',
