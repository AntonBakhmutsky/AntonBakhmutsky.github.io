...
<script id="basket-item-template" type="text/html">
	<tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}"
				...
				<div class="basket-item-block-image<?= (! isset($mobileColumns['PREVIEW_PICTURE']) ? ' hidden-xs' : '') ?>">
					...
					<a href="{{DETAIL_PAGE_URL}}" class="basket-item-image-link">
						...
						<div class="basket-item-label-text basket-item-label-big <?= $labelPositionClass ?>">
							{{#LABEL_VALUES}}
							<div
							{{#HIDE_MOBILE}} class="hidden-xs"{{/HIDE_MOBILE}}>
                            ...
                            switch (trim((string)$blockName)) {
                                ...
                                case 'sku':
									...
									<div class="basket-item-property basket-item-property-scu-image"
									     data-entity="basket-item-sku-block" data-prop="{{CODE}}">
										<div class="basket-item-property-value">
									...
									{{^IS_IMAGE}}
									<div class="basket-item-property basket-item-property-scu-text {{CODE}}"
