					...
					<div class="info__wrap">
						<div class="info__top">
                                ...
                                <div id="<?= $itemIds['TREE_ID'] ?>">
                                    ...
                                    foreach ($arResult['SKU_PROPS'] as $skuProperty) {
                                        ...
                                        if ($skuProperty['CODE'] === 'SIZE') {
                                            ...
                                            <span class="info__link info__link_cert">Выберите номинал сертификата</span>
                                            <?php
                                        } ?>
                                                ...
                                                if ($value['ID'] > 0) {
                                                    ...
                                                    <label class="info__sizes-item" title="<?= $value['NAME'] ?>"
                                                        ...
                                                        if ($skuProperty['CODE'] === 'SIZE') { ?>
                                                            ...
                                                            <div class="info__sizes-item-image info__sizes-item-image_cert" title="<?= $value['NAME'] ?>">
                                                                <?= File::isFileExists($path = Application::getDocumentRoot() . $value['PICT']['SRC'])
                                                                    ? File::getFileContents($path)
                                                                    : $value['NAME'] ?>
                                                            </div>
                            ...
                            if ($arResult['PREVIEW_TEXT']) { ?>
								<div class="info__desc"><?= $arResult['PREVIEW_TEXT'] ?></div>
                                <?php
                            } ?>
							...
							<div class="info__submit" id="<?= $itemIds['BASKET_ACTIONS_ID'] ?>"
								...
								<a href="javascript:void(0);" id="<?= $itemIds['ADD_BASKET_LINK'] ?>">Купить</a>
							</div>
						...
						<div class="info__items">
                            ...
                            if ($arResult['DETAIL_TEXT']) { ?>
								<div class="info__item">
									<div class="info__item-visible">
										<div class="info__item-title">Описание</div>
										<div class="info__item-arrow"></div>
									</div>
									<div class="info__item-hidden"><?= $arResult['DETAIL_TEXT'] ?></div>
								</div>
                                <?php
                            }
                            foreach ($arResult['DISPLAY_PROPERTIES'] as $property) { ?>
								<div class="info__item">
									<div class="info__item-visible">
										<div class="info__item-title"><?= $property['NAME'] ?></div>
										<div class="info__item-arrow"></div>
									</div>
									<div class="info__item-hidden"><?= $property['DISPLAY_VALUE'] ?></div>
								</div>
                                <?php
                            } ?>
						</div>
