...
if ($request->get('ORDER_ID') <> '') {
			...
			<div class="col-sm-9 bx-soa">
					...
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container">
							...
							<div class="col-xs-12 col-sm-3 text-right"><a href="javascript:void(0)"
							                                              class="bx-soa-editstep"><span><?= $arParams['MESS_EDIT'] ?></span></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
					</div>
                <?
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container">
						...
						<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><span><?= $arParams['MESS_EDIT'] ?></span></a></div>
					</div>
					<div class="bx-soa-section-content container-fluid"></div>
				</div>
                        ...
                        if ($arParams['USER_CONSENT'] === 'Y') {
                            app()->IncludeComponent(
                                ...
                                [
                                    ...
                                    'AUTO_SAVE' => 'N',
                                    'INPUT_NAME' => 'ORDER_USER_AGREEMENT',
	...
	<div id="bx-soa-user-consent" style="display:none">
        <?php
        app()->IncludeComponent(
            'bitrix:main.userconsent.request',
            '',
		...
		BX.saleOrderAjax.init(<?=CUtil::PhpToJSObject(
            [
                ...
                'messages' => [
                    ...
                    'notFoundPrompt' => '<div class="-bx-popup-special-prompt">' . Loc::getMessage('SOA_LOCATION_NOT_FOUND') . '.<br />' . Loc::getMessage(
                            'SOA_LOCATION_NOT_FOUND_PROMPT',
                            [
                                '#ANCHOR#' => '<a href="javascript:void(0)" class="-bx-popup-set-mode-add-loc" style="display: inline">',
                                '#ANCHOR_END#' => '</a>'
                            ]
                        ) . '</div>'
                ]
