...
$defaultValue = ['-' => GetMessage('CP_BCS_TPL_PROP_EMPTY')];
$arSKU = false;
$boolSKU = false;
$filterDataValues = [];
...
$arTemplateParameters['PRODUCT_ROW_VARIANTS'] = [
    'PARENT' => 'VISUAL',
...
$arTemplateParameters['ENLARGE_PRODUCT'] = [
    'PARENT' => 'VISUAL',
...
if ($iblockExists) {
    ...
    if (! empty($showedProperties)) {
        ...
        $arTemplateParameters['PROPERTY_CODE_MOBILE'] = [
            'PARENT' => 'VISUAL',
    ...
    if (isset($arCurrentValues['ENLARGE_PRODUCT']) && $arCurrentValues['ENLARGE_PRODUCT'] === 'PROP') {
        $arTemplateParameters['ENLARGE_PROP'] = [
            'PARENT' => 'VISUAL',
    ...
    if ($boolSKU) {
        $arTemplateParameters['PRODUCT_DISPLAY_MODE'] = [
            'PARENT' => 'VISUAL',
...
if (isset($arCurrentValues['LAZY_LOAD']) && $arCurrentValues['LAZY_LOAD'] === 'Y') {
    $arTemplateParameters['MESS_BTN_LAZY_LOAD'] = [
        'PARENT' => 'PAGER_SETTINGS',
...
$arTemplateParameters['MESS_BTN_DETAIL'] = [
    'PARENT' => 'VISUAL',
