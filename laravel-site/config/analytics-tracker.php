...
return [
     ...
     *
     * Available sources can be found in the `\App\AnalyticsTracker\Sources` namespace.
     */
    'tracked_parameters' => [
        [
            'key' => 'utm_source',
            'source' => App\AnalyticsTracker\Sources\RequestParameter::class,
        ],
        [
            'key' => 'utm_medium',
            'source' => App\AnalyticsTracker\Sources\RequestParameter::class,
        ...
        [
            'key' => 'referer',
            'source' => App\AnalyticsTracker\Sources\CrossOriginRequestHeader::class,
        ],
    ],
