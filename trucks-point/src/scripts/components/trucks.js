...
window.addEventListener('load', () => {
  if (!document.querySelector('.trucks')) {
    ...
    const calendar9 = new VanillaCalendar('#calendar-input9', options);
    calendar9.init();
    const calendar10 = new VanillaCalendar('#calendar-input10', options);
    calendar10.init();
    const calendar11 = new VanillaCalendar('#calendar-input11', options);
    calendar11.init();
